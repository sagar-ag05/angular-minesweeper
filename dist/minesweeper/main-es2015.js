...
/* harmony import */ var _shared_cell__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/cell */ "./src/shared/cell.ts");
    ...
    populateMineWithBombs() {
        ...
        for (let i = 0; i < this.scale; i++) {
            ...
            for (let j = 0; j < this.scale; j++) {
                ...
                let c = new _shared_cell__WEBPACK_IMPORTED_MODULE_2__["Cell"](counter++, isBomb, 0);
                arr.push(c);
            }
            this.mine.push(arr);
        }
...
class Cell {
    constructor(_id, _isBomb, _count) {
        this._isOpen = false;
    }
}
...
module.exports = __webpack_require__(/*! /Users/Sagar_Agrawal/SelfS/Interviews/minesweeper/src/main.ts */"./src/main.ts");
